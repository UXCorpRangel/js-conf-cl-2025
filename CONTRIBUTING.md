# Contribuyendo al repositorio del sitio web oficial de JSConf Chile 2025
...
> [!IMPORTANT]
> Si estás viendo este repositorio en la organización de la comunidad de JavaScript Chile, **te recomendamos que visites el repositorio donde se lleva a cabo el desarrollo del proyecto en la organización de [UXCorpRangel](https://github.com/UXCorpRangel/js-conf-cl-2025).**
...
2. **Revisa el Backlog**: Consulta el [backlog en ClickUp](https://app.clickup.com/9011774466/v/l/s/90113123580) para ver cómo puedes ayudar o deja una [issue](https://github.com/UXCorpRangel/js-conf-cl-2025/issues) para sugerir una nueva característica o error.
...
2. **Crea un Nuevo Issue**: Si el problema es nuevo, abre un issue en la [sección de Issues](https://github.com/UXCorpRangel/js-conf-cl-2025/issues) con una descripción clara y concisa del problema.

## ¿Cómo proponer nuevas características?

Para proponer una nueva característica:

1. **Abre un Issue**: Antes de comenzar a trabajar en la nueva característica, abre un nuevo issue para discutir la idea en la [sección de Issues](https://github.com/UXCorpRangel/js-conf-cl-2025/issues).
2. **Recibe Retroalimentación**: Espera comentarios y sugerencias de los colaboradores o mantenedores antes de proceder.

## ¿Cómo hacer un fork?

Para contribuir al repositorio del sitio web oficial de JSConf Chile 2025, primero necesitas hacer un fork del repositorio:

1. **Ve al Repositorio en GitHub**: Accede a [JSConf 2025 en GitHub](https://github.com/UXCorpRangel/js-conf-cl-2025).
...
```bash
git clone git@github.com:UXCorpRangel/js-conf-cl-2025.git
```
...
Al contribuir al repositorio del sitio web oficial de JSConf Chile 2025, aceptas que tus contribuciones estén sujetas a la [Licencia del Proyecto](./LICENSE).

---

Gracias por tu interés y tu contribución al repositorio del sitio web oficial de JSConf Chile 2025. ¡Tu ayuda es muy valiosa!
